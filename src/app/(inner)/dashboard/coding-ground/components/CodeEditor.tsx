...
} from "../components/SelectLanguages";
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
...
export default function CodeEditor() {
  ...
  return (
    <div className="md:h-[90vh] dark:bg-slate-900 rounded-2xl shadow-2xl py-6 px-8">
      {/* EDITOR HEADER */}
      ...
      <div className="bg-slate-400 dark:bg-slate-950 p-3 rounded-2xl">
        ...
        >
          ...
          <ResizablePanel defaultSize={50} minSize={35}>
            {/* Header */}
            <div className="space-y-3 bg-slate-300 dark:bg-slate-900 md:h-75vh">
